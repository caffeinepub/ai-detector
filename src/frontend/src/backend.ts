...
export interface backendInterface {
    /**
     * / Detects if a paragraph contains mostly AI-generated text.
     * / This is done using heuristic signals, such as uniform sentence length, low vocabulary diversity and repetition.
     * /
     * / Returns a score between 0 and 1, indicating the likelihood of AI-generation.
     * /
     */
...
export class Backend implements backendInterface {
    ...
    async getScore(arg0: string): Promise<number> {
